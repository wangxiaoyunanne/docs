...
Note that the `rand` modes have very bad scaling as a function of cores.  __Should revisit this, to make sure it's real.__

We run the undirected random mode from 100K seeds instead of the full 7.1M because it is so much slower.
